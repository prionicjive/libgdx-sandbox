package com.innerlogic.libgdx.common.screens;
...
public abstract class BaseMainMenuScreen extends ScreenAdapter {
	...
	protected final InnerLogicGame _game;
	...
	public BaseMainMenuScreen(final InnerLogicGame game, final String welcomeText, final String clickToBeginText) {
		_game = game;
