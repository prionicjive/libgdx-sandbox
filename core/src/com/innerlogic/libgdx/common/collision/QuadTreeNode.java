package com.innerlogic.libgdx.common.collision;
...
public class QuadTreeNode {
	...
	/**
	 * Stores all entities that could collide with the given object
	 */
	public void retrieve(Array<SpriteEntity> entitiesToReturn, SpriteEntity entity) {
		// If we have any child nodes, see if the entity could be contained completely inside of one
		// of them
		if (childNodes.size > 0) {
			int index = getIndex(entity);
