package com.innerlogic.libgdx.modules.particlesgalore.particles;
...
import com.innerlogic.libgdx.common.utils.UserFloatTextureData;
...
public class ParticleSystem {
	...
	public ParticleSystem(final InnerLogicGame game) {
		_game = game;
	...
	private void initializeShaders() {
		...
		psTexture = _game.assetManager.get(InnerLogicGame.TEXTURE_PARTICLE);
	}
