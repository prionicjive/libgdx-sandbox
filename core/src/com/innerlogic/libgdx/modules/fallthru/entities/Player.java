package com.innerlogic.libgdx.modules.fallthru.entities;
...
import com.innerlogic.libgdx.common.entities.SpriteEntity;

public class Player extends SpriteEntity {
	// ---------------------------
	// Private members
	// ---------------------------
	private InnerLogicGame _game;
	...
	public Player(InnerLogicGame game) {
		super(game.assetManager.get(InnerLogicGame.TEXTURE_PLAYER, Texture.class));
		...
		spriteSheet = game.assetManager.get(InnerLogicGame.TEXTURE_PLAYERANMIATION, Texture.class);
