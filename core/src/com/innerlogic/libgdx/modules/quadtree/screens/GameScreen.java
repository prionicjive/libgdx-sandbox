...
import com.innerlogic.libgdx.common.collision.QuadTreeNode;
import com.innerlogic.libgdx.common.entities.SpriteEntity;
import com.innerlogic.libgdx.common.utils.logging.PeriodicLogger;
...
public class GameScreen extends ScreenAdapter {
	...
	private SpriteEntity generateValidBlock() {
		SpriteEntity block = new SpriteEntity(_game.assetManager.get(InnerLogicGame.TEXTURE_BLOCK, Texture.class));
		block.setSize(4, 4);
