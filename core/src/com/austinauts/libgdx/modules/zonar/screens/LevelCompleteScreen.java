...
public class LevelCompleteScreen extends ScreenAdapter {
	...
	private void drawText() {
		drawTextWithShadow(_game.batch, bigFont, completeText, completePos.x, completePos.y);
